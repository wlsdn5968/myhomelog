...
| **052** | **검색창 자동완성도 공백 든 질의를 못 찾는다** | P1 | S | 051 머지 후(normalizeName 재사용) | TODO |
...
| **057** | **"지역 + 단지명" 질의를 지역으로 좁혀 찾는다 (051 의 누락, 라이브 실측 발견)** | **P0** | S | 051 | TODO |
| **058** | **조용한 낡음 감시 — 검색 색인 21일 정지가 경보 없었다 + 열화 전파 2곳** | **P1** | S | 054 | TODO |
