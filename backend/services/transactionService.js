...
const LAWD_CODES = {
  ...
  // HWASEONG-4GU-2026-08-30 (Sprint OOOOOOO, 운영자 친구 실제 질문에서 발각):
  //   "서동탄역파크자이 1,2차" 를 찾는데 우리 데이터에 **없었다**. 네이버 지도 실조회 결과
  //   경기도 화성시 **병점구** 능동 1282 — 화성시는 동탄구 외에 3개 구가 더 있다.
  //   [공식 확정 — KAPT getSigunguAptList4 의 as2 실조회]
  //     41591 화성만세구(새솔동 등) · 41593 화성효행구(기안동·봉담) · 41595 화성병점구(병점·진안·능동)
  //   [실거래 실측 202607] 41591 114건 · 41593 198건 · 41595 496건 (41590 통합코드는 0건 = 폐지)
  //   서동탄역파크자이 1·2차는 41595 에 실재하고 최근 6개월 **90건** 거래된다(전용 77㎡ 5.43억 등).
  //   동탄구만 넣고 나머지를 빠뜨린 것 — 같은 '화성시' 인데 검색이 안 되는 상태였다.
  '화성시만세구': '41591', '화성시효행구': '41593', '화성시병점구': '41595',
