  ...
  res.json({
    ...
    decisions: [
...

      {
        ...
        // M-2 ①안 (2026-05-10): 본 카테고리(AI 채팅·분석·특약 생성) 응답 한정 별점·점수 강조 금지.
        //   1Page 컨설팅 보고서(/api/report/generate) 의 PDF 컨설팅 톤 ★ 표기는 별도 정책 (REPORT_SPECIFIC).
        //   섹션 이름 ('AI 채팅·분석·특약 생성') 과 문구를 일치시켜 모순 차단.
        safeguards: [
          '매수·매도 권유 표현 금지',
          '미래 가격 단정 금지',
          '별점/점수 강조 금지 (※ 본 카테고리(AI 채팅·분석·특약) 응답 한정 — 1Page 컨설팅 보고서의 PDF 컨설팅 톤 ★ 표기는 별도 정책으로 허용)',
