...
-- ============================================================================
-- [무엇인가]
--   Plan 103 — 최고·최저 경신 기준선을 2020-09 이후 이력까지 넓힘.
--   근거: 351→159·137→61, 이력 힙 직접 조회는 콜드 13.9초라 요약 테이블,
--   면적 조인식의 32767 캡 이유 = 327㎡ 초과에서 smallint 범위 오류 방지.
-- [되돌리기 SQL]
--   DROP TABLE public.molit_hist_peaks;
-- ============================================================================
